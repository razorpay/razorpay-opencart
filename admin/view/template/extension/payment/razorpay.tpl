    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-razorpay" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-webhook-status"><?php echo $entry_webhook_status; ?></label>
            <div class="col-sm-10">
              <select name="razorpay_webhook_status" id="input-webhook-status" class="form-control">
                <?php if ($razorpay_webhook_status) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group"><span class="input-group-addon"><i class="fa fa-link"></i></span>
                <input type="text" readonly value="<?php echo $razorpay_webhook_url; ?>" id="input-webhook-url" class="form-control" />
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div class="text-danger"><?php echo $error_webhook_secret; ?></div>
              <?php } ?>
            </div>
          </div>
